...
`;
export const Share = ({ setDisplayShared, post }) => {
  ...
  return (
    <ShareWrapper>
      <button className='exit-btn' type='button' onClick={exit}></button>
      <section className='share-section'>
        ...
        />
          ...
          ></textarea>
        <Button className='share-btn' type='button' onClick={share}>Share Now</Button>
        </section>
      </section>
    </ShareWrapper>
  )
